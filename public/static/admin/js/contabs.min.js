...
$(function() {
                    ...
                    $(".J_mainContent .J_iframe").each(function() {
                        if ($(this).data("id") == o) {
                            if(reload==true){
                                ...
                                var n = '<iframe class="J_iframe" name="iframe' + m + '" width="100%" height="100%" src="' + iframs + '" frameborder="0" data-id="' + o + '" seamless></iframe>';
    ...
    function e() {
        ...
        var fl = $(this).data("reload");
        if (!$(this).hasClass("active")) {
            var k = $(this).data("id");var ind = $(this).data("index");
            $(".J_mainContent .J_iframe").each(function() {
                if ($(this).data("id") == k) {
                    if(fl==true){
                        $(this).remove().siblings(".J_iframe").hide();
...
$(function(){
    function getTopNavDate(){  //获取顶部导航
        ...
        $(".navbar-static-top ul.nav-left").html(topStr);
    }
    getTopNavDate();
    ...
    function hideTopli(){   //顶部导航超出隐藏
        ...
        $(".nav-left").find("li").each(function(i){
            ...
            w += liW;
            if(w>topW){
                $("#navbarSubMenu a").css("display","block");
                var t = $(this).clone();
                $("#navbarSubMenu ul").append($(this).clone());
                $(this).css("display","none");

            }else{
                $("#navbarSubMenu a").css("display","none");
            }
        })
